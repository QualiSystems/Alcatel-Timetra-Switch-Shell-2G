...
from cloudshell.devices.runners.run_command_runner import (
    RunCommandRunner as CommandRunner,
)
...
from cloudshell.networking.alcatel.cli.alcatel_cli_handler import (
    AlcatelCliHandler as CliHandler,
)
from cloudshell.networking.alcatel.runners.alcatel_autoload_runner import (
    AlcatelAutoloadRunner as AutoloadRunner,
)
...
from cloudshell.networking.alcatel.runners.alcatel_firmware_runner import (
    AlcatelFirmwareRunner as FirmwareRunner,
)
from cloudshell.networking.alcatel.snmp.alcatel_snmp_handler import (
    AlcatelSnmpHandler as SnmpHandler,
)


class AlcatelTimetraRouterShell2GDriver(
    ...
    def get_inventory(self, context):
        ...
        :param context: object with all Resource Attributes inside
    ...
    def ApplyConnectivityChanges(self, context, request):
        ...
        logger.info(
            "Start applying connectivity changes, request is: {0}".format(str(request))
        )
    ...
    def load_firmware(self, context, path, vrf_management_name):
        ...
        response = firmware_operations.load_firmware(
            path, vrf_management_name=vrf_management_name
        )
